...
(custom-theme-set-faces
  'soft-stone
	...
	'(powerline-active1 ((t (:foreground "#faf0e7" :background "#d7cdb8"))))
	'(powerline-active2 ((t (:foreground "#faf0e7" :background "#aca49f"))))
